...
{
    public class ConfigurationChannelLoggerSettings : IChannelLoggerSettings
    {
        private readonly IConfiguration _configuration;

        public ConfigurationChannelLoggerSettings(IConfiguration configuration)
        {
        ...
        {
            ChangeToken = null;
            return new ConfigurationChannelLoggerSettings(_configuration);
        }
